  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/images/desert-arg.webp)',
          backgroundAttachment: 'fixed',
        }}
      >
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#848484]/80 via-[#848484]/50 to-[#848484]/70" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="#contact"
              className="group relative bg-[#EFB4A7] hover:bg-[#EFB9B0] text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 hover:shadow-xl hover:shadow-[#EFB4A7]/30 overflow-hidden"
            >
            ...
            <a
              href="#destinations"
              className="text-white border-2 border-white/30 hover:border-[#EFB4A7] hover:text-[#EFB4A7] px-8 py-4 rounded-full text-lg font-medium transition-all duration-300"
            >
              {t('nav.destinations')}
            </a>
          </div>
