          ...
          {destinations.map((dest, index) => (
            ...
            >
              ...
              <div className="relative h-80 overflow-hidden">
                ...
                {/* Location Badge */}
                <div className="absolute top-4 left-4 bg-[#C9A962] text-white text-xs font-semibold px-3 py-1.5 rounded-full">
                  {dest.key === 'noa' && 'NOA'}
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="text-xl font-bold text-[#2D2D2D] mb-2 group-hover:text-[#C9A962] transition-colors duration-300">
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center gap-2 text-[#C9A962] font-semibold hover:gap-3 transition-all duration-300"
                >
                  {t('destinations.cta')}
              ...
              {/* Hover Border Effect */}
              <div className="absolute inset-0 border-2 border-[#C9A962] rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
            </div>
          ))}
        </div>
      </div>
